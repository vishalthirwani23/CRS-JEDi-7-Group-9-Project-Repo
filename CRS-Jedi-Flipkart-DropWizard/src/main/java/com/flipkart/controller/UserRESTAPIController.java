...
public class UserRESTAPIController {
    ...
    final static StudentInterface studentInterface = new StudentOperation();
    final static NotificationInterface notificationInterface = new NotificationOperation();
    final static AdminInterface adminInterface = new AdminOperation();
...
//                                       @Email(message = "Email not in right")
        ...
        try {
            ...
            if (!loggedin) return Response.status(401).entity("Incorrect Old Password").build();
